...
## Full Join 
This is an exammple showing all four tables being joined.
...
jobs_df <- dbGetQuery(con,"WITH skills_by_id AS (
                  ...
                  SELECT j.job_id, job_title, job_summary, job_location, search_position, job_level, job_type, c.company, s.skills
                  FROM jobs AS j
