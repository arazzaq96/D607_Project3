...
#### JOSE: Note that this is where it breaks. Ariba was working with a version that had one skill per row in a column called "skill_name." I reverted it back to a comma_delim single colum called "skills" that looks like this "Machine Learning, Programming, Python, Scala, Java, Data Engineering, Distributed Computi". You will need to break this column back up into rows and give the name she gave "skill_name" to get it to work from here on.
